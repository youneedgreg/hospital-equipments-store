...
import { Users, Package, ShoppingCart, Building2, ShieldCheck, BarChart3, Search, Eye, Calendar } from "lucide-react"
...
const orders = [
  {
    ...
    date: "2024-01-15",
    items: [
      { name: "Digital Blood Pressure Monitor", qty: 10, price: 8500 },
  ...
  },
  {
    ...
    date: "2024-01-15",
    items: [
      { name: "Laboratory Centrifuge", qty: 2, price: 35000 },
      { name: "Test Tubes (Pack of 100)", qty: 10, price: 1950 },
    ],
  ...
  },
  {
    ...
    status: "pending",
    date: "2024-01-14",
    items: [{ name: "First Aid Kit - Professional", qty: 15, price: 3000 }],
    paymentMethod: "MPesa",
  ...
  },
  {
    ...
    date: "2024-01-14",
    items: [
      { name: "Patient Monitor", qty: 1, price: 85000 },
      { name: "Pulse Oximeter", qty: 5, price: 12500 },
    ],
    paymentMethod: "Bank Transfer",
    paymentStatus: "paid",
  },
  {
    ...
    status: "cancelled",
    date: "2024-01-13",
    items: [{ name: "Microscope - Binocular", qty: 2, price: 28500 }],
    paymentMethod: "MPesa",
  ...
  return (
    <div className="flex min-h-screen bg-muted/30">
      ...
      <div className="flex-1 flex flex-col lg:pl-64">
        <DashboardHeader title="Order Management" userType="admin" onMenuClick={() => setMobileNavOpen(true)} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-2xl font-bold text-yellow-600">KES {pendingPayments.toLocaleString()}</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4">
                  ...
                  <TableBody>
                    {filteredOrders.map((order) => (
                      <TableRow key={order.id}>
                        ...
                        <TableCell className="font-semibold">KES {order.amount.toLocaleString()}</TableCell>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">via {selectedOrder.paymentMethod}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="space-y-3">
                  {selectedOrder.items.map((item, index) => (
                    <div key={index} className="flex justify-between items-start p-3 bg-muted/50 rounded-lg">
                      ...
                      <p className="font-semibold text-sm">KES {(item.qty * item.price).toLocaleString()}</p>
                    </div>
                  ))}
                </div>
              </div>
